...
enum kernel_id {
    ...
    K_Q4K_MATVEC_F32_HBM,
    K_Q4K_MATVEC_FULL_HBM,         // canonical-nibble + qs/hdr-split, 8-row unrolled
    ...
    K_FLASH_ATTN_EXT_F32Q_BF16KV_TILE_HBM,
    K_FLASH_ATTN_EXT_F32Q_BF16KV_TILE_INTRIN_HBM,
    K_FLASH_ATTN_EXT_F32Q_BF16KV_TILE_VEXP_HBM,
    K_FLASH_ATTN_EXT_F32Q_BF16KV_TILE_FAST_HBM,
    K_FLASH_ATTN_EXT_F32Q_BF16KV_TILE_PACK2_HBM,
    K_FLASH_ATTN_EXT_F32Q_BF16KV_TILE_UNR2_HBM,
    K_FLASH_ATTN_EXT_F32Q_BF16KV_TILE_UNR4_HBM,
    K_FLASH_ATTN_EXT_F32Q_BF16KV_TILE_UNR8_HBM,
