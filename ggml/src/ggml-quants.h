...
GGML_API void quantize_row_vebp_ref(const float * GGML_RESTRICT x, block_vebp * GGML_RESTRICT y, int64_t k);
...
GGML_API void dequantize_row_vebp(const block_vebp * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
